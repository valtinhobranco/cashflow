...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private const int FORMAT_PADDING_INDENT = 20;
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        { 
            ...
            row.Cells[0].Format.LeftIndent = FORMAT_PADDING_INDENT;
            ...
            if(string.IsNullOrWhiteSpace(expense.Description) == false)
            {
              var description = table.AddRow();
                ...
                description.Cells[0].Format.LeftIndent = FORMAT_PADDING_INDENT;
    ...
    private Document createDocument(DateOnly month) {
        ...
        document.Info.Author = "Valter Branco Filho";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo", "perfilPdf.png");



        row.Cells[0].AddImage(pathFile);
        row.Cells[1].AddParagraph("Hey Valter Branco Filho");
        row.Cells[1].Format.Font = new Font { Name = FontHelper.RALEWAY_EXTRABOLD, Size = 16 };
    ...
    private void AddExpenseTitle(Cell cell,string expenseTitle)
    {
        ...
        cell.Format.Font = new Font { Name = FontHelper.RALEWAY_EXTRABOLD, Size = 14, Color = ColorsHelper.BLACK };
        cell.Shading.Color = ColorsHelper.RED_LIGHT;
        cell.VerticalAlignment = VerticalAlignment.Center;
        cell.MergeRight = 2;
        cell.Format.LeftIndent = FORMAT_PADDING_INDENT;
    }
    private void AddHeaderForAmount(Cell cell)
    {
        cell.AddParagraph(ResourceReportGenerationMessages.AMOUNT);
        cell.Format.Font = new Font { Name = FontHelper.RALEWAY_EXTRABOLD, Size = 14, Color = ColorsHelper.WHITE };
        cell.Shading.Color = ColorsHelper.RED_DARK;
        cell.VerticalAlignment = VerticalAlignment.Center;
        cell.Format.RightIndent = FORMAT_PADDING_INDENT;
    }
